var _analytics = (function (exports) {
  ...
  var f = "any",
      ...
      l = "undefined" != typeof process && null != process.versions && null != process.versions.node,
      d = "undefined" != typeof Deno && void 0 !== Deno.core,
      p = "object" == typeof self && self.constructor && "DedicatedWorkerGlobalScope" === self.constructor.name,
      y = a && "nodejs" === window.name || "undefined" != typeof navigator && (navigator.userAgent.includes("Node.js") || navigator.userAgent.includes("jsdom"));
  ...
  function s$1(r$$1) {
    return function (e$$1) {
      ...
      return a && window.location.search.substring(1);
    }(r$$1));
  }
  ...
  function getUserPropFunc(storage) {
    return function getUserProp(key, instance, payload) {
      ...
      if (payload && S(payload) && payload[key]) {
        /*
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              pluginObject = g(getPlugins) ? getPlugins() : getPlugins;
  ...
  function shouldAbortAll(_ref5, pluginsCount) {
    ...
    if (!abort) return false;
    if (abort === true || m(abort)) return true;
  ...
  */
  ...
  var initialState$3 = {
    ...
    version: null,
    debug: false,
    offline: a ? !navigator.onLine : false,
    // use node network is-online
    os: {
      name: osName
    },
    userAgent: a ? navigator.userAgent : 'node',
  ...
  function ensureArray(singleOrArray) {
    ...
    if (z(singleOrArray)) return singleOrArray;
  ...
  function analytics() {
        ...
        regenerator.mark(function _callee(userId, traits, options, callback) {
          ...
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  id = m(userId) ? userId : null;
                  data = S(userId) ? userId : traits;
                  opts = options || {};
                  user = instance.user();
        ...
        regenerator.mark(function _callee2(eventName, payload, options, callback) {
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  name = S(eventName) ? eventName.event : eventName;
                ...
                case 3:
                  data = S(eventName) ? eventName : payload || {};
    ...
    if (a && config.debug) {
      ...
      composeWithGlobalDebug = function composeWithGlobalDebug() {
        ...
        if (S(_typeof_1(arguments[0]))) return composeWithDebug(arguments[0]);
  ...
  function I(o$$1, r$$1) {
    if (o$$1) {
      ...
      if (a$$1 && !v(l$$1)) return l$$1;
      var n$$1 = b$2(e$$1) ? y$2(c$2(o$$1)) : void 0;
      if (a$$1 && n$$1) return n$$1;
      var u$$1 = f$2(o$$1);
      return a$$1 ? u$$1 : {
        localStorage: l$$1,
        cookie: n$$1,
  ...
  function C$1(t$$1, r$$1) {
    if (t$$1) {
      var a$$1 = L$1(r$$1),
          i$$1 = I(t$$1, s),
          n$$1 = {};
      return !v(i$$1.localStorage) && O$1(a$$1) && (localStorage.removeItem(t$$1), n$$1[a$3] = i$$1.localStorage), !v(i$$1.cookie) && b$2(a$$1) && (a$2(t$$1), n$$1[i$2] = i$$1.cookie), !v(i$$1.global) && d$3(a$$1, l$2) && (t$1(t$$1), n$$1[l$2] = i$$1.global), n$$1;
    }
  }

  function L$1(t$$1) {
    return t$$1 ? m(t$$1) ? t$$1 : t$$1.storage : f;
  }
  ...
  function b$2(t$$1) {
    return k && d$3(t$$1, i$2);
  }

  function A$1(t$$1) {
    return t$$1 === s || "all" === t$$1;
  }
